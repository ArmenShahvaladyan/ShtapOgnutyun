...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setOfficePhoneNumber() {
        UserRequestSevice.sharedInstance.getOfficePhoneNumber(succsesBlock: {
    ...
    func setRootViewController() {
        if let isFirstLaunch = UserDefaults.standard.value(forKey: "isFirstLaunch") as? Bool {
            ...
            window?.rootViewController = LanguageViewController(nibName: "LanguageViewController", bundle: nil)
        }
    }
}
